...
import time
import warnings
_str = "\n\n---[ Semantic segmentation trainer version: " + str(_tv) + " ]---\n"
warnings.warn(_str)
...
def one_epoch_ss(**kargs):
    ...
    if i_mode == "val":
        tmp_is_best = dict_rb[i_mode]["ious"].is_best_max or dict_rb[i_mode]["loss"].is_best_min
...
def trainer_(**kargs):
    ...
    for i_epoch in range(HP_EPOCH):
        ...
        for i_mode in list_mode:
            ...
            is_best =      one_epoch_ss(HP_DETECT_LOSS_ANOMALY = HP_DETECT_LOSS_ANOMALY
