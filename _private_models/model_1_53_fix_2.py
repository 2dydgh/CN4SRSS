...
v 1.53
    ...
    *** v 1.55 에서 되돌아옴 *** - 2023_07_12
    --- fix 1
        loss 에서 의미없는 _weight 계산 주석처리
...
class block_a(nn.Module):
    def __init__(self, in_c, mid_c, out_c, use_m1=True, use_m2=True):
        ...
        if use_m2:
            print("m2 = SCAA = SASA = True")
            self.layer_1_3 = SASA(in_c, 1)
        else:
            print("m2 = SCAA = SASA = False")
...
class model_I2F(nn.Module):
    ...
    def __init__(self, in_c, mid_c, basic_blocks, use_m1=True, use_m2=True):
        ...
        self.layer_mid_1 = stack_block(block_a(mid_c, mid_c//2, mid_c, use_m1=use_m1, use_m2=use_m2), count=basic_blocks//3, recursive=False)
        self.layer_mid_2 = stack_block(block_a(mid_c, mid_c//2, mid_c, use_m1=use_m1, use_m2=use_m2), count=basic_blocks//3, recursive=False)
        self.layer_mid_3 = stack_block(block_a(mid_c, mid_c//2, mid_c, use_m1=use_m1, use_m2=use_m2), count=basic_blocks//3, recursive=False)
...
class proposed_loss(nn.Module):
    def __init__(self, is_amp=True, kd_mode=None):
        ...
        if self.kd_mode == "kd_p_1": # from m 1.53 fix 2
            _str = "kd_p_1 is not used anymore."
            warning.warn(_str)
            sys.exit(-9)
