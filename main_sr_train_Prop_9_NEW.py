...
if __name__ == '__main__':
    #from _private_models.Prop_9_NEW_Ab_51   import model_proposed, loss_proposed
    #from _private_models.Prop_9_NEW_Ab_52   import model_proposed, loss_proposed
    #from _private_models.Prop_9_NEW_Ab_53   import model_proposed, loss_proposed
    #from _private_models.Prop_9_NEW_Ab_54   import model_proposed, loss_proposed
    from _private_models.ARNet import model_proposed_SR, loss_proposed
    ...
    model_sr_name = "model_c"   # list output -> list_sr_model_type_a
    
    model_sr = model_proposed_SR()
    update_dict_v2("", ""
                  ,"", "모델 정보: " + model_sr_name
                  ,"", "(custom)"
                  ,"", "pretrained = False"
    ...
    if option_scheduer == "Poly_Warm_Cosine":
        ...
        HP_SCHEDULER_WARM_STEPS         = 200           # (warm-up cos) warm-up 시행 step 수
        ...
        HP_SCHEDULER_TOTAL_EPOCH        = 3000          # (poly) LR 0.0 도달 step
