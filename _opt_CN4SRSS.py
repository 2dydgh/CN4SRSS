...
# parser_options.add_argument("--calc_with_logit",   type = str2bool,    default = False,      help = "set this False to apply softmax to semantic segmentation logit")
...
# (bool) detect loss anomaly
parser_options.add_argument("--dla", type = str2bool, default = True, help = "detect loss anomaly")
...
#--- argparse -> parser
args_options = parser_options.parse_args()  # argparse 라이브러리를 사용하여 정의된 명령줄 인자 파싱
