...
# apply_cj (color jitter data augmentation): bool (True, False)
# parser_options.add_argument("--apply_cj",   type = str2bool,    default = True,      help = "set this True to apply color jitter data augmentation")

# LR, WD
# parser_options.add_argument("--HP_LR_T",    type = float, default = None, help = "Learning Rate for Teacher")
# parser_options.add_argument("--HP_WD_T",    type = float, default = None, help = "Weight Decay  for Teacher")
# parser_options.add_argument("--HP_LR_S",    type = float, default = None, help = "Learning Rate for Student")
# parser_options.add_argument("--HP_WD_S",    type = float, default = None, help = "Weight Decay  for Student")
# parser_options.add_argument("--HP_LR_M",    type = float, default = None, help = "Learning Rate for seMantic segmentation")
# parser_options.add_argument("--HP_WD_M",    type = float, default = None, help = "Weight Decay  for seMantic segmentation")
# parser_options.add_argument("--HP_LR_SRSS", type = float, default = None, help = "Learning Rate for CN4SRSS")
# parser_options.add_argument("--HP_WD_SRSS", type = float, default = None, help = "Weight Decay  for CN4SRSS")

# batch size
# parser_options.add_argument("--HP_BATCH_TRAIN", type = int, default = None, help = "HP_BATCH_TRAIN")
