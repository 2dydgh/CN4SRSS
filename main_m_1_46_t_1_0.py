# main_m_1_46_t_1_0.py

if __name__ == '__main__':
    import matplotlib
    matplotlib.use("Agg")
    
    from _private_models.model_1_46         import proposed_model, proposed_loss, proposed_loss_ss
    from utils.schedulers                   import PolyLR, Poly_Warm_Cos_LR
    from _private_models.trainer_1_0        import *
    from _opt_v2                            import *
    ...
    if criterion_s is not None:
        ...
        update_dict_v2("", "loss 정보"
                      ...
                      ,"", "wce alpha n beta: " + str(wce_alpha) + " and " + str(wce_beta)
                      ,in_dict = dict_log_init
                      ,in_print_head = "dict_log_init"
                      )
    ...
    # ss
    optimizer_ss = torch.optim.Adam(model_l.parameters(), lr = HP_LR_SS, weight_decay = HP_WD_SS, betas= (0.9, 0.99))  # student
    ...
    trainer_(# <patch를 통해 학습 & RGB 이미지를 생성하는 모델>#
            ...
            ,criterion_s                    = criterion_s
             ...
             # (SS) model, optimizer, scheduler, loss
            ,model_l                        = model_l
