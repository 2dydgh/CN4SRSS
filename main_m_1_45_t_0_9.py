# main_m_1_45_t_0_9.py

if __name__ == '__main__':
    import matplotlib
    matplotlib.use("Agg")
    
    from _private_models.model_1_45         import proposed_model, proposed_loss, proposed_loss_ss
    from utils.schedulers                   import PolyLR, Poly_Warm_Cos_LR
    from _private_models.trainer_0_9        import *
    from _opt_v2                            import *
    ...
    criterion_ss = proposed_loss_ss(ignore_index=HP_CHANNEL_HYPO)
    
    criterion_l = proposed_loss_ss(ignore_index=HP_CHANNEL_HYPO)
