...
if __name__ == '__main__':
    ...
    #[optimizer]------------------------
    HP_LR = 4e-4                    # LAPAR official: 4e-4 (ADAM)
    HP_WD = 0
    optimizer = optim.Adam(model_sr.parameters()
                          ,lr             = HP_LR
                          ,betas          = (0.9, 0.999)
                          ,eps            = 1e-8
                          ,weight_decay   = HP_WD
    ...
    update_dict_v2("", ""
                  ...
                  ,"", "scheduler: " + "CosineAnnealingLR_warmup (LAPAR_A 자체 제공)"
    ...
    trainer_(# <patch를 통해 학습 & RGB 이미지를 생성하는 모델>#
            ...
            ,HP_EPOCH                       = HP_EPOCH
            ,HP_BATCH_TRAIN                 = 32                # LAPAR official: 32
            ,HP_BATCH_VAL                   = 1
            ,HP_BATCH_TEST                  = 1
            ...
            ,is_force_fix                   = True
            ,force_fix_size_hr              = (256, 256)                # LAPAR - official 설정 : LR 기준 64x64
            ...
            ,HP_AUGM_LITE_FLIP_VERT         = True                      # FLIP: 수직방향
