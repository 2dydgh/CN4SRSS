...
list_path_out = load_file_path(in_path_dataset = "C:/Users/user/PycharmProjects/sample_4/MiniCity_19_DLC_v1"
                              ,in_category = "original"
                              ,in_category_sub = "images"
                              )

dict_from_csv = csv_2_dict(path_csv = "C:/Users/user/PycharmProjects/sample_4/MiniCity_19_DLC_v1/degradation_MiniCity.csv")
...
for i_name in range(len(list_path_out)):
    ...
    save_pil(
             ...
             pil = out_pil
             #(str) 저장경로: ".asd/fghj"
            ,path = "C:/Users/user/PycharmProjects/sample_4/MiniCity_19_DLC_v1/x" + str(HP_SCALE_FACTOR) + "_" +HP_INTERPOLATION_METHOD + "/images"
             #(str) 파일이름 + 확장자: "name.png"
            ,name = in_name
            )
