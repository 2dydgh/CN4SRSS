...
if __name__ == '__main__':
    from DLCs.super_resolution.model_pan    import PAN, CosineAnnealingLR_Restart   # loss: torch.nn.L1Loss()
    ...
    #[optimizer]------------------------
    HP_LR = 1e-3                    # PAN official: 1e-3 (ADAM)
    HP_WD = 0
    ...
    update_dict_v2("", ""
                  ...
                  ,"", "scheduler: " + "CosineAnnealingLR_Restart (PAN 자체 제공)"
                  ,"", "eta_min: " + str(HP_ETA_MIN)
                  ,in_dict = dict_log_init
                  ,in_print_head = "dict_log_init"
                  )
    ...
    trainer_(# <patch를 통해 학습 & RGB 이미지를 생성하는 모델>#
            ...
            ,HP_EPOCH                       = HP_EPOCH
            ,HP_BATCH_TRAIN                 = 32                # PAN official: 32
            ,HP_BATCH_VAL                   = 1
            ,HP_BATCH_TEST                  = 1
            ...
            ,is_force_fix                   = True
            ,force_fix_size_hr              = (256, 256)                # PAN - official 설정 : HR 기준 256x256
