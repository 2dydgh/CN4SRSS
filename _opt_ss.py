...
parser_options.add_argument("--alter_hr",           type = str,         default = "HR",     help = "Alter HR image")
...
parser_options.add_argument("--calc_with_logit",    type = str2bool,    default = True,     help = "set this False to apply softmax to semantic segmentation logit")

# label onehot encode
parser_options.add_argument("--onehot",             type = str2bool,    default = None,     help = "set this True to encode label in onehot shape")
